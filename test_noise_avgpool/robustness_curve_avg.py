...
# The results
epsilons = [0.0, 0.001, 0.002, 0.005, 0.007]
verified_rates = [100.0, 95.0, 85.0, 40.0, 20.0]  # % Safe
...
plt.title('Robustness Curve ($L_\infty$) with Average Pooling', fontsize=14, fontweight='bold', pad=15)
...
print("Graph generated successfully: robustness_curve_avg.png")